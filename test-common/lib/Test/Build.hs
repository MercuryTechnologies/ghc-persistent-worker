...
initialStrategy :: SessionEnv -> Bool -> Dispatch Component
initialStrategy env useIncremental =
  Dispatch \case
...
resumeStrategy :: SessionEnv -> Bool -> Bool -> Dispatch ResumeComponent
resumeStrategy env useIncremental fixErrors =
  Dispatch \case
